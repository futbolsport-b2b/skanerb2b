...
async function startQR() {
    ...
    document.body.classList.add("qr-mode"); // Ustaw tryb QR
...
async function startEAN() {
    ...
    document.body.classList.add("ean-mode"); // Ustaw tryb EAN
    setCornersColor("white");
...
function showError(m) {
    isProcessing = true;
    setCornersColor("#ff453a"); // Czerwona ramka
    playBeep(200, 600);
    ...
    setTimeout(() => { 
        ...
        isProcessing = false; 
        setCornersColor("white"); // Powrót do białego
    }, 1500);
}
